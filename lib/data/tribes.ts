...
// كل قبيلة لها رمز فريد (jersey number) — لا تكرار
export const TRIBES: Tribe[] = [
  ...
  { id: "khalid",   code: "912", name: "بني خالد",  aliases: ["بني خالد", "خالد", "912", "خالدي"],           color: "#CD5C5C" },
  ...
  { id: "sahool",   code: "506", name: "السهول",    aliases: ["السهول", "سهول", "506"],                      color: "#6A5ACD" },
  ...
  { id: "anazah",   code: "504", name: "عنزة",      aliases: ["عنزة", "عنزي", "B-52", "504"],                color: "#32CD32" },
  ...
  { id: "bali",     code: "812", name: "بلي",       aliases: ["بلي", "بليوي", "812"],                        color: "#FF69B4" },
];
